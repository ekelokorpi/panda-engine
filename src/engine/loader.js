...
game.Loader = game.Class.extend({
    ...
    **/
    ...
    initStage: function() {
        ...
        barBg.beginFill(0x231f20);
        barBg.drawRect(0, 0, 200, 20);
        barBg.position.set(game.system.width / 2 - 100, game.system.height / 2 + 70);
        this.stage.addChild(barBg);

        this.bar = new game.Graphics();
        this.bar.beginFill(0xe6e7e8);
