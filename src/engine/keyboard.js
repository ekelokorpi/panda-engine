...
game.Keyboard = game.Class.extend({
    ...
    keydown: function(event) {
        ...
        if(game.scene && typeof(game.scene.keydown) === 'function') game.scene.keydown(event.keyCode);
    },

    keyup: function(event) {
        this.keys[event.keyCode] = false;
        if(game.scene && typeof(game.scene.keyup) === 'function') game.scene.keyup(event.keyCode);
    }
});
